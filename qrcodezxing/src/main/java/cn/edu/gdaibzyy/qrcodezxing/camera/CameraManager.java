package cn.edu.gdaibzyy.qrcodezxing.camera;
...
public final class CameraManager {
	 ...
	 */
	public cn.edu.gdaibzyy.qrcodezxing.camera.PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
		...
		case PixelFormat.YCbCr_422_SP:
			return new cn.edu.gdaibzyy.qrcodezxing.camera.PlanarYUVLuminanceSource(data, width, height, rect.left,
		...
		default:
			...
			if ("yuv420p".equals(previewFormatString)) {
				return new cn.edu.gdaibzyy.qrcodezxing.camera.PlanarYUVLuminanceSource(data, width, height,
