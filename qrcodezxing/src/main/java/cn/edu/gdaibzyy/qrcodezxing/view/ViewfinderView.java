 ...
 */
package cn.edu.gdaibzyy.qrcodezxing.view;
...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			canvas.drawText(getResources().getString(R.string.qrcode_scanner_text_tip), frame.left, (float) (frame.bottom + (float)TEXT_PADDING_TOP *density), paint);
